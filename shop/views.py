    ...
    if request.method =='GET':
        ...
        if request.POST['password1']==request.POST['password2']:
            try:
                ...
                return render(request,'shop/signup.html',{'form':UserCreationForm(),"error":'Username already Taken'})
        else:
            return render(request,'shop/signup.html',{'form':UserCreationForm(),"error":'Password Didnt Match'})
